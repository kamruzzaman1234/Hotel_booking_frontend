        ...
        <SwiperSlide className="mb-[40px] px-[40px] border-r-5 border-t-5 shadow-lg border-yellow-400 py-[20px] rounded-lg">
            <div className="flex flex-col gap-8">
                    <div className="flex justify-center flex-col gap-3 items-center">
                       ...
                       <FaFacebookF className="text-[24px] text-black" />       
                        <FaTwitter className="text-[24px] text-black" />        
                        <FaInstagram className="text-[24px] text-black" />       
                        <FaLinkedinIn className="text-[24px] text-black" />    
                        <FaEnvelope className="text-[24px] text-black" />   
                ...
                <div className="flex gap-6 ">
                    ...
                    <div className="w-[250px] flex flex-col gap-3">
                        ...
                        <div>
                            <h3 className="text-[18px] font-bold">Davit John</h3>
