            ...
            <div className="container">
                <div className="flex flex-col gap-10">
                    ...
                    <div className="grid sm:grid-cols-1 md:grid-cols-2 gap-4 lg:grid-cols-4">
                        ...
                        rounded-tl-[20px] rounded-br-[20px]">
                            <div className="w-full h-[300px]">
                                <img src="https://i.ibb.co/Y74G1xv3/h6.jpg" alt="" className="w-full h-full object-cover 
                                rounded-tl-[20px] rounded-br-[20px]"/>
                            </div>
                            <div classNa="flex flex-col">
                                <div>
                        ...
                        rounded-tl-[20px] rounded-br-[20px]">
                            <div className="w-full h-[300px]">
                                <img src="https://i.ibb.co/ptFCWSX/h4.jpg" alt="" className="w-full h-full object-cover 
                                rounded-tl-[20px] rounded-br-[20px]"/>
                            </div>
                            <div classNa="flex flex-col">
                                <div>
                        ...
                        rounded-tl-[20px] rounded-br-[20px]">
                            <div className="w-full h-[300px]">
                                <img src="https://i.ibb.co/pvP2ng1f/h5.jpg" alt="" className="w-full h-full object-cover 
                                rounded-tl-[20px] rounded-br-[20px]"/>
                            </div>
                            <div classNa="flex flex-col">
                                <div>
