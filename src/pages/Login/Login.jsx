    ...
    return(
      ...
      <div className="flex shadow-2xl rounded overflow-hidden">
        ...
        <div className="w-[600px] bg-white p-10">
          <h2 className="text-3xl uppercase font-bold text-center mb-6 text-gray-800">Login</h2>
          ...
          <p className="text-center text-[18px] font-medium text-gray-600 mt-4">
            Create On Account !! Please  <span className="text-blue-600 hover:underline cursor-pointer">Register</span>
          </p>
        </div>
      </div>
    </div>
